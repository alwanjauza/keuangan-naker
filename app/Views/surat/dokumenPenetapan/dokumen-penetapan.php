            ...
            <div class="card-body">
                ...
                <form class="row g-3">
                    ...
                    <div class="button-baru text-end pe-3">
                        <a href="<?= site_url('tambah-dokumen-penetapan') ?>" class="btn btn-primary"
                            style="width: 10%;">BARU</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <table class="table table-striped table-md">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $value['tgl_masa_awal'] . "~" . $value['tgl_masa_akhir'] ?></td>
                                <td><?= $value['nama'] ?></td>
                                <td><?= $value['untuk'] ?></td>
                                <td><?= $value['jml'] ?></td>
                                <td><?= $value['jml_terima'] ?></td>
                                <td class="text-center" style="width: 15%;">
                                    <a href="<?= site_url('dokumen-penetapan/edit/' . $value['id']) ?>"
                                        class="btn btn-outline-primary btn-sm disabled"><i
