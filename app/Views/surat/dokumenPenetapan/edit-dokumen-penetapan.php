                ...
                <form class="row g-1" action="<?= site_url('dokumen-penetapan/' . $dokumen_penetapan['id']) ?>" method="post" autocomplete="off">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input placeholder="Tanggal Bukti" name="tgl_bukti" type="date" class="form-control datepicker" id="tgl_bukti">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-default"><i class="fa-solid fa-calendar-days"></i></span>
                            <input placeholder="Tanggal Masa" value="<?= $dokumen_penetapan['tgl_masa_awal'] . "~" . $dokumen_penetapan['tgl_masa_akhir'] ?>" name="masa" type="date" class="form-control datepicker">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-default"><i class="fa-solid fa-calendar-days"></i></span>
                            <input placeholder="Tanggal Jatuh Tempo" name="tgl_jatuh_tempo" value="<?= $dokumen_penetapan['tgl_jth_tempo'] ?>" type="date" class="form-control datepicker">
                        </div>
                    </div>
